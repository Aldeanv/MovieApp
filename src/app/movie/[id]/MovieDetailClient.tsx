...
import { Star, Clock, Calendar, Play, User, Film, DollarSign, Languages, Quote, Video } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 space-y-6">
                ...
                {(movie.budget > 0 || movie.revenue > 0) && (
                  <motion.div variants={slideUp} className="flex flex-wrap gap-4 pt-2">
                    {movie.budget > 0 && (
                ...
                {movie.spoken_languages?.length > 0 && (
                  <motion.div variants={slideUp} className="flex items-center gap-2 pt-2">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        >
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700/50">
            <h3 className="text-xl font-bold mb-4 text-amber-400">Production</h3>
          ...
          {/* Financial Info */}
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700/50">
            <h3 className="text-xl font-bold mb-4 text-amber-400">Financials</h3>
            <div className="space-y-3">
              <div>
                <p className="text-gray-400 text-sm">Budget</p>
                <p className="text-gray-300">
                  {movie.budget > 0 ? formatCurrency(movie.budget) : "Not available"}
                </p>
              </div>
              <div>
                ...
                >
                  <Link href={`/person/${cast.id}`} className="block">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-400 mt-1">{cast.character}</p>
                    </div>
                  </Link>
                </motion.div>
              ))}
